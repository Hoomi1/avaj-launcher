...
import ft.school21.avaj.simulator.ArgumentException;
...
public class AircraftFactory {
    public static Flyable newAircraft(String type, String name, int longitude, int latitude, int height) throws ArgumentException {
